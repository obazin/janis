...
| Command                                                    | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Preference commands (6, in `src-tauri/src/persistence.rs`) | `get_preferences` — the single boot fetch (volume, EQ gains+preset, playback switches, hide-title-bar, language). `set_volume(volume)` / `set_eq(gains, preset)` / `set_playback_option(option, enabled)` (closed enum: `gapless` \| `crossfade` \| `normalize` \| `exclusive`) / `set_title_bar_hidden(hidden)` (persist only — the frameless window is applied at runtime from the frontend via `setDecorations`, no Rust window handling) / `set_language(language)` (`en` \| `fr`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
